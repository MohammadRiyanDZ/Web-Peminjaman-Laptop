        ...
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="nim" class="form-label">NIS Siswa</label>
                        <input type="number" class="form-control w-50" id="nis" placeholder="Masukkan NIS" min="1" name="nim" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" id="rayon" placeholder="Masukkan rayon" name="rayon" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="semester" class="form-label">Nomor Laptop</label>
                        <input type="number" class="form-control w-50" id="semester" placeholder="Masukkan Nomor Laptop" name="semester" autocomplete="off" required>
                    </div>
